...
public class UpdateComplaintInUCMSRequest  implements java.io.Serializable {
    ...
    private UpdateComplaintInUCMSRequestDataHeader dataHeader;
    ...
    public UpdateComplaintInUCMSRequest(
           ...
           UpdateComplaintInUCMSRequestDataHeader dataHeader) {
     ...
     * @return dataHeader
     */
    public UpdateComplaintInUCMSRequestDataHeader getDataHeader() {
        return dataHeader;
    }
     ...
     * @param dataHeader
     */
    public void setDataHeader(UpdateComplaintInUCMSRequestDataHeader dataHeader) {
        this.dataHeader = dataHeader;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.etisalat.ae/Middleware/UCMSComplaintIntegration/UpdateComplaintStatusInUCMSRequest.xsd", ">UpdateComplaintInUCMSRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.etisalat.ae/Middleware/UCMSComplaintIntegration/UpdateComplaintStatusInUCMSRequest.xsd", "DataHeader"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.etisalat.ae/Middleware/UCMSComplaintIntegration/UpdateComplaintStatusInUCMSRequest.xsd", ">>UpdateComplaintInUCMSRequest>DataHeader"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
