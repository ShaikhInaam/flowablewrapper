/**
 * OfferInformationFafInformationList.java
 *
...
public class OfferInformationFafInformationList  implements java.io.Serializable {
    ...
    public OfferInformationFafInformationList() {
    }
    ...
    /**
     * Gets the promotionNotificationFlag value for this OfferInformationFafInformationList.
     * 
    ...
    /**
     * Sets the promotionNotificationFlag value for this OfferInformationFafInformationList.
     * 
    ...
    /**
     * Gets the firstIVRCallSetFlag value for this OfferInformationFafInformationList.
     * 
    ...
    /**
     * Sets the firstIVRCallSetFlag value for this OfferInformationFafInformationList.
     * 
    ...
    /**
     * Gets the accountActivationFlag value for this OfferInformationFafInformationList.
     * 
    ...
    /**
     * Sets the accountActivationFlag value for this OfferInformationFafInformationList.
     * 
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof OfferInformationFafInformationList)) return false;
        OfferInformationFafInformationList other = (OfferInformationFafInformationList) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OfferInformationFafInformationList.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.etisalat.ae/Middleware/INCommunicationManagement/GetAccountDetailsResponse.xsd", ">>OfferInformation>fafInformationList"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("promotionNotificationFlag");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.etisalat.ae/Middleware/INCommunicationManagement/GetAccountDetailsResponse.xsd", "promotionNotificationFlag"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.etisalat.ae/Middleware/INCommunicationManagement/GetAccountDetailsResponse.xsd", "firstIVRCallSetFlag"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.etisalat.ae/Middleware/INCommunicationManagement/GetAccountDetailsResponse.xsd", "accountActivationFlag"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
