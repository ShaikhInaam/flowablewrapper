...
public class GetDADetailsRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the applicationHeader value for this GetDADetailsRequest.
     * 
    ...
    /**
     * Sets the applicationHeader value for this GetDADetailsRequest.
     * 
    ...
    /**
     * Gets the dataHeader value for this GetDADetailsRequest.
     * 
     * @return dataHeader
     */
    public GetDADetailsRequestDataHeader getDataHeader() {
        return dataHeader;
    }


    /**
     * Sets the dataHeader value for this GetDADetailsRequest.
     * 
     * @param dataHeader
     */
    public void setDataHeader(GetDADetailsRequestDataHeader dataHeader) {
        this.dataHeader = dataHeader;
    }

    private Object __equalsCalc = null;
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof GetDADetailsRequest)) return false;
        GetDADetailsRequest other = (GetDADetailsRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetDADetailsRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.etisalat.ae/Middleware/INCommunicationManagement/GetDADetailsRequest.xsd", ">GetDADetailsRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.etisalat.ae/Middleware/INCommunicationManagement/GetDADetailsRequest.xsd", "DataHeader"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.etisalat.ae/Middleware/INCommunicationManagement/GetDADetailsRequest.xsd", ">>GetDADetailsRequest>DataHeader"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
